<!--
 * @Author: Qing Shi
 * @LastEditTime: 2022-04-30 23:39:01
 * @Knowledge: 
 * @Description: 
 * @Attention: 
-->
      ...
      let circles = scatter_g
        ...
        .on('mouseover', d => {
          if (d3.select("#nodePic").attr("sid") != 1) {
            ...
            tooltip.html("<img style='height: 100%; width: 100%; border-radius: 10px; border: solid 2px black;' src='" + "/src/assets" + selData.path.slice(1) + "'>")
              .style("left", (tx) + "px")
              .style('top', ty + 'px')
