...
export default {
  ...
  data () {
    return {
      ...
      // pth: { filePath: "/src/visData/wikiVSmidVSsemTSNE3.csv" },
      // pth: { filePath: "/src/visData/wikiVSmidVSsemTSNE3_plus_brightness_blur.csv"},
      // pth: {filePath: "/src/visData/wikiVSmidVSsemTSNE3_plus_brightness_blur_colorhar7.csv"}
      // pth: {filePath: "/src/visData/wikiVSmidVSsemTSNE3_plus_brightness_blur_colorhar8.csv"}
      // pth:{filePath: "/src/visData/fivedatasets_features.csv"}
      pth:{filePath: "/src/visData/sixdatasets_true_features.csv"}
    }
  },
  provide () {
  ...
  methods: {
     ...
     * @return {*}
     */    
    updateTree (treeData, sumTree,num) {
      console.log("DDDDrawwwTree!!")
      this.$refs.histo.Draw(num);
    ...
    draw (data) {
      console.log("DDDDrawww!!")
      this.$refs.histo.Draw(data);
    },
    /**
...
#selectView {
  position: absolute;
  left: 5px;
  top: calc(29.5% + 15px + 1px);
  /* height: calc(58% - 30px); */
  height: calc(65.7% + 9px);
  width: 14%;
  /* border: solid 1px rgb(163, 163, 163); */
  border: solid 2px #A5C6C6;
  /* border-radius: 5px; */
